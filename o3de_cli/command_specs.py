...
COMMAND_SPECS: dict[str, dict] = {
    ...
    "engine create": {
        ...
        "fields": [
            _field("name", "Engine Name", required=True,
                   placeholder="my-engine", positional=True),
            _field("path", "Location", "path",
                   placeholder="_resolve_default_"),
            _field("template", "Template", "template_choice",
                   placeholder="Select a template..."),
            _field("auto_register", "Register after creation", "flag"),
        ],
        "state_changing": True,
        "object_types": ["engine"],
        "context": "global",
    ...
    "project init": {
        ...
        "fields": [
            _field("name", "Project Name", required=True,
                   placeholder="my-game", positional=True),
            _field("path", "Location", "path",
                   placeholder="_resolve_default_"),
            _field("template", "Template", "template_choice",
                   placeholder="Select a template..."),
    ...
    "template instance": {
        ...
        "fields": [
            _field("template_name", "Template", "template_choice",
                   required=True, from_selected="name"),
    ...
    "repo create": {
        ...
        "fields": [
            _field("name", "Repo Name", required=True,
                   placeholder="my-repo", positional=True),
            _field("path", "Location", "path",
                   placeholder="_resolve_default_"),
            _field("template", "Template", "template_choice",
                   placeholder="Select a template..."),
    ...
    "overlay create": {
        ...
        "fields": [
            _field("name", "Overlay Name", required=True,
                   placeholder="my-overlay", positional=True),
            _field("path", "Location", "path",
                   placeholder="_resolve_default_"),
            _field("template", "Template", "template_choice",
                   placeholder="Select a template..."),
